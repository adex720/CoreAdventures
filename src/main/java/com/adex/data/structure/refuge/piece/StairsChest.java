...
public class StairsChest extends StairsUp {
    ...
    public StairsChest(int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
        super(ModStructures.REFUGE_STAIRS_CHEST, index, boundingBox, direction, pos);
    }

    public StairsChest(int index, int x, int y, int z, Direction direction) {
        this(index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public StairsChest(CompoundTag compoundTag) {
        super(ModStructures.REFUGE_STAIRS_CHEST, compoundTag);
    }

    public StairsChest(StructurePieceType type, int index, int x, int y, int z, Direction direction) {
        this(type, index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public StairsChest(StructurePieceType type, int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
