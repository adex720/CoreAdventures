...
public class RisingThreeWayMiddle extends RefugePiece {
    ...
    public RisingThreeWayMiddle(int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
        super(ModStructures.REFUGE_RISING_THREE_WAY_MIDDLE, index, boundingBox, direction, pos);
    }
    ...
    public RisingThreeWayMiddle(CompoundTag compoundTag) {
        super(ModStructures.REFUGE_RISING_THREE_WAY_MIDDLE, compoundTag);
    }

    public RisingThreeWayMiddle(StructurePieceType type, int index, int x, int y, int z, Direction direction) {
        this(type, index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public RisingThreeWayMiddle(StructurePieceType type, int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
