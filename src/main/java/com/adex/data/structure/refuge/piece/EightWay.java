...
public class EightWay extends RefugePiece {
    ...
    public EightWay(int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
        super(ModStructures.REFUGE_EIGHT_WAY, index, boundingBox, direction, pos);
    }
    ...
    public EightWay(CompoundTag compoundTag) {
        super(ModStructures.REFUGE_EIGHT_WAY, compoundTag);
    }

    public EightWay(StructurePieceType type, int index, int x, int y, int z, Direction direction) {
        this(type, index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public EightWay(StructurePieceType type, int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
