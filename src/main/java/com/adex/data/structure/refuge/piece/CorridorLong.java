...
public class CorridorLong extends RefugePiece {
    ...
    public CorridorLong(StructurePieceType refugeCorridorChest, CompoundTag compoundTag) {
        super(refugeCorridorChest, compoundTag);
    }
