...
public class RefugeBuilder {
    ...
    private static PieceCreator[] createPieceCreator() {
        return new PieceCreator[]{
                ...
                new PieceCreator(EmptyRoom::new, 5, 2, EmptyRoom::getBaseBoundingBox),
                new PieceCreator(TreasureRoom::new, 5, 3, 2, TreasureRoom::getBaseBoundingBox),
                ...
                new PieceCreator(FarmRoom::new, 5, 3, 2, FarmRoom::getBaseBoundingBox),
                ...
                new PieceCreator(DiningRoom::new, 5, 4, 2, DiningRoom::getBaseBoundingBox),
                new PieceCreator(JailRoom::new, 5, 2, 6, JailRoom::getBaseBoundingBox),
                ...
                new PieceCreator(CorridorJailLeft::new, 5, 3, CorridorJailLeft::getBaseBoundingBox),
                new PieceCreator(CorridorJailRight::new, 5, 3, CorridorJailRight::getBaseBoundingBox),
