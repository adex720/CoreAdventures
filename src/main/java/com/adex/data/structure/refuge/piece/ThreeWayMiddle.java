...
public class ThreeWayMiddle extends RefugePiece {
    ...
    public ThreeWayMiddle(int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
        super(ModStructures.REFUGE_THREE_WAY_MIDDLE, index, boundingBox, direction, pos);
    }

    public ThreeWayMiddle(int index, int x, int y, int z, Direction direction) {
        this(index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public ThreeWayMiddle(CompoundTag compoundTag) {
        super(ModStructures.REFUGE_THREE_WAY_MIDDLE, compoundTag);
    }

    public ThreeWayMiddle(StructurePieceType type, CompoundTag compoundTag) {
        super(type, compoundTag);
    }

    public ThreeWayMiddle(StructurePieceType type, int index, int x, int y, int z, Direction direction) {
        this(type, index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public ThreeWayMiddle(StructurePieceType type, int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
