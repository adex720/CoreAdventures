...
public class TurnRight extends RefugePiece {
    ...
    public TurnRight(int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
        super(ModStructures.REFUGE_TURN_RIGHT, index, boundingBox, direction, pos);
    }

    public TurnRight(int index, int x, int y, int z, Direction direction) {
        this(index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public TurnRight(CompoundTag compoundTag) {
        super(ModStructures.REFUGE_TURN_RIGHT, compoundTag);
    }

    public TurnRight(StructurePieceType type, int index, int x, int y, int z, Direction direction) {
        this(type, index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public TurnRight(StructurePieceType type, int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
