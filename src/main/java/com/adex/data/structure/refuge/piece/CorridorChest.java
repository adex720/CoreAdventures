...
public class CorridorChest extends CorridorLong {
    ...
    public CorridorChest(StructurePieceType type, int index, int x, int y, int z, Direction direction) {
        this(type, index, getBaseBoundingBox(direction).moved(x, y, z), direction, new BlockPos(x, y, z));
    }

    public CorridorChest(StructurePieceType type, int index, BoundingBox boundingBox, Direction direction, BlockPos pos) {
