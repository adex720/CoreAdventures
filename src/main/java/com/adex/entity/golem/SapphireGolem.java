...
public class SapphireGolem extends Golem {

    public SapphireGolem(EntityType<? extends Monster> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Golem.createAttributes().add(Attributes.MOVEMENT_SPEED, 0.5d);
    }
