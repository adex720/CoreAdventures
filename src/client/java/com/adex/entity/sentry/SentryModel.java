...
public class SentryModel extends EntityModel<SentryRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("handRight", CubeListBuilder.create().texOffs(32, 0).addBox(0.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offset(4.0f, 2.0f, 0.0f));
        partdefinition.addOrReplaceChild("handLeft", CubeListBuilder.create().texOffs(16, 32).addBox(-4.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offset(-4.0f, 2.0f, 0.0f));
        partdefinition.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(0, 32).addBox(-2.0f, -0.0f, -2.0f, 4.0f, 12.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offset(2.0f, 12.0f, 0.0f));
        partdefinition.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(24, 16).addBox(-2.0f, -0.0f, -2.0f, 4.0f, 12.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offset(-2.0f, 12.0f, 0.0f));
