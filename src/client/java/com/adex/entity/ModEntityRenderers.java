...
public class ModEntityRenderers {
    ...
    public static void initialize() {
        ...
        EntityRenderers.register(ModEntities.PRIMED_YELLOW_TNT, StrongTntRenderer::new);
        EntityRenderers.register(ModEntities.PRIMED_GREEN_TNT, StrongTntRenderer::new);
        EntityRenderers.register(ModEntities.PRIMED_BLUE_TNT, StrongTntRenderer::new);
